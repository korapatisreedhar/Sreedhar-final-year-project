...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center">Vehicle Service Provider LogIn</h2>
		  <p>&nbsp;</p>
...
<form name="s" action="v_authentication.jsp" method="post" onSubmit="return valid()"  ons target="_top">  
            
    <table align="center" border="1" width="51%" height="146">
	
      <tr>
        <td width="48%" height="25" bgcolor="#00a3e0" class="style4 style2"><span class="style9 style4 style5 style7 style1 style2 style3"> Name </span></td>
        <td width="55%" height="25" bgcolor="#00a3e0"><input type="text"  name="userid" size="15" /></td>
      </tr>
      <tr>
        <td width="48%" height="25" bgcolor="#00a3e0" class="style5 style2"> <span class="style9 style4 style5 style7 style1 style2 style3">Password</span></td>
	...
	<p align="center" class="style2">New User? <a href="v_register.jsp">Register Here</a></p>
</form>		  
