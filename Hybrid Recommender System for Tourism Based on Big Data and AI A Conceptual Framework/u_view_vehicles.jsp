...
<%	  
 ...
 try 
	{		
      	                    String query="select vname,user from vehicles "; 
		...
		%>
                    ...
                    <tr>
					  ...
					  <td bgcolor="#CC0000"><div align="center" class="style13 style11 style12 style5 style6 style10"><%=s1%></div></td>
					  <td bgcolor="#CC0000"><div align="center" class="style13 style11 style12 style5 style6 style10"><a href="u_vsp_profile.jsp?user=<%=s2%>&type=<%="one"%>"><%=s2%></a></div></td>
					  <td bgcolor="#CC0000"><div align="center" class="style6 style13 style11 style12 style5 style7 style9"><a href="u_view_vehicles1.jsp?vname=<%=s1%>&sp=<%=s2%>">Click Here</a></div></td>
	      </tr>
