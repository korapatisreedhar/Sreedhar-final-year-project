...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center">View All Vehicle Service Provider and Authorize</h2>
		  <p>&nbsp;</p>
...
<table width="610" border="1.5" cellpadding="0" cellspacing="0" align="center">
         <tr bgcolor="#00FF33">
		   ...
		   <td width="90" bgcolor="#9eb8dd"><div align="center" class="style12 style5 style6 style7">VSP Image  </div></td>
           <td width="103" bgcolor="#9eb8dd"><div align="center" class="style12 style5 style6 style7">VSP Name  </div></td>
	...
	{		
		...
		%>
                    ...
                    <tr>
					  ...
					  <td width="138" align="center" bgcolor="#00FFFF"><a href="a_vsp_profile.jsp?user=<%=s2%>&type=<%="two"%>" class="style11 style10 style5 style6">Click here</a></td>
					  <%
              ...
              <td bgcolor="#00FFFF"><div align="center" class="style11 style12 style13 style14 style10 style5 style6">
                <a href="vsp_Status.jsp?id=<%=i%>" class="style16 ">waiting</a> </div></td>
              <%
						}
						else
						{
