...
<table width="573" border="0" align="center">
    ...
    <tr>
      <td>&nbsp;</td>
      <td height="40" bgcolor="#CCCC00"><span class="style38 style17 style6 style20 style22 style25"><strong>Spot Description </strong>(Description Encrypted)</span></td>
      <td width="247" bgcolor="#669966"><textarea id="s" name="d13" cols="30" rows="5" readonly="readonly"><%=ss4%></textarea></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    ...
    <tr>
      <td>&nbsp;</td>
      <td height="40" bgcolor="#CCCC00"><span class="style38 style17 style6 style20 style22 style25"><strong>Hotel Description </strong>(Description Encrypted)</span></td>
      <td width="247" bgcolor="#669966"><textarea id="s" name="d16" cols="30" rows="5" readonly="readonly"><%=ss7%></textarea></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    ...
    <tr>
      <td>&nbsp;</td>
      <td height="40" bgcolor="#CCCC00"><span class="style38 style17 style6 style20 style22 style25"><strong>Spot Description </strong>(Description Encrypted)</span></td>
      <td width="247" bgcolor="#669966"><textarea id="s" name="d13" cols="30" rows="5" readonly="readonly"><%=ss10%></textarea></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td height="40" bgcolor="#CCCC00"><span class="style38 style17 style6 style20 style22 style25"><strong>Famous For </strong></span></td>
    ...
    <tr>
      <td>&nbsp;</td>
      <td height="40" bgcolor="#CCCC00"><span class="style38 style17 style6 style20 style22 style25"><strong>Hotel Description </strong>(Description Encrypted)</span></td>
      <td width="247" bgcolor="#669966"><textarea id="s" name="d16" cols="30" rows="5" readonly="readonly"><%=ss13%></textarea></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td height="40" bgcolor="#CCCC00"><span class="style38 style17 style6 style20 style22 style25"><strong>Available Items </strong></span></td>
    ...
    <tr>
      <td>&nbsp;</td>
      <td height="40" bgcolor="#CCCC00"><span class="style38 style17 style6 style20 style22 style25"><strong>Spot Description </strong>(Description Encrypted)</span></td>
      <td width="247" bgcolor="#669966"><textarea id="s" name="d13" cols="30" rows="5" readonly="readonly"><%=ss16%></textarea></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td height="40" bgcolor="#CCCC00"><span class="style38 style17 style6 style20 style22 style25"><strong>Famous For </strong></span></td>
    ...
    <tr>
      <td>&nbsp;</td>
      <td height="40" bgcolor="#CCCC00"><span class="style38 style17 style6 style20 style22 style25"><strong>Hotel Description </strong>(Description Encrypted)</span></td>
      <td width="247" bgcolor="#669966"><textarea id="s" name="d16" cols="30" rows="5" readonly="readonly"><%=ss19%></textarea></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td height="40" bgcolor="#CCCC00"><span class="style38 style17 style6 style20 style22 style25"><strong>Available Items </strong></span></td>
...
if(type.equalsIgnoreCase("one"))
		...
		%><p align="right"><a href="a_tree_spot.jsp?user=<%=user2%>" class="style9 style22">Back</a></p>
<%
		}
		if(type.equalsIgnoreCase("two"))
		{
		%><p align="right"><a href="a_booked_spots.jsp" class="style9 style22">Back</a></p>
<%
		}
