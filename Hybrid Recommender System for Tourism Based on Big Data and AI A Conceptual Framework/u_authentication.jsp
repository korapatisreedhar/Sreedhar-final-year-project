...
try {
		...
		if (rs.next()==true)
		{
								...
								if(rs1.next()==true)
								{
									...
									String s8=rs1.getString(8);//addr
									...
									application.setAttribute("addr",s8);
									application.setAttribute("loc",s9);
									application.setAttribute("latitude",s10);
									application.setAttribute("longitude",s11);
