...
<head>
<title>User Routing the Same Spot in Map</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center">View Users Routing the Same Tourist Spot in Map</h2>
		  <p>&nbsp;</p>
...
<% String loc = request.getParameter("loc"); %>
          ...
          <p align="center" class="style5"><span class="style10">For the Location :</span> <span class="style11"><%=loc%></span> </p>

<iframe src="u_same_path_map1.jsp?loc=<%=loc%>" style="border:3px;" width="620" height="600"></iframe>
