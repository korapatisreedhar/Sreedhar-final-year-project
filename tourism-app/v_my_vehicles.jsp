...
<head>
<title>View My Added Vehicles</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center">View My Added Vehicles</h2>
		  <p>&nbsp;</p>
...
<table width="610" border="1.5" cellpadding="0" cellspacing="0" align="center">
         <tr bgcolor="#00FF33">
           ...
           <td width="158" bgcolor="#9eb8dd"><div align="center" class="style3 style20 style27 style6 style11 style12 style13 style5 style7 style8"><strong>Vehicle Type</strong></div></td>
		   <td width="162" bgcolor="#9eb8dd"><div align="center" class="style3 style20 style27 style6 style11 style12 style13 style5 style7 style8"><strong>Vehicle Price/Km(Rs)</strong></div></td>
		 </tr>
...
<%	  
 ...
 try 
	{		
      	                    String query="select * from vehicles where user='"+user+"' "; 
