...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center">Vehicle Service Provider Profile</h2>
		  <p>&nbsp;</p>
...
<%
		...
		%><p align="right"><a href="u_view_tourist_spots2.jsp?loc=<%=loc%>&sp=<%=sp%>" class="style9">Back</a></p>
<%
		}
