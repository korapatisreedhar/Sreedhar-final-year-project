...
try{
		...
		if(type.equalsIgnoreCase("one"))
			{
			  %><p align="left"><a href="u_accounts.jsp" class="style4">Back</a></p><%
			}
            else if(type.equalsIgnoreCase("two"))
			{
			%><p align="left"><a href="u_view_tourist_spots.jsp" class="style4">Back</a></p><%
			}
			else if(type.equalsIgnoreCase("three"))
			{
			%><p align="left"><a href="u_view_vehicles.jsp" class="style4">Back</a></p><%
			}
