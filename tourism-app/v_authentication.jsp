...
<%
	...
	application.setAttribute("vsp",name);

try {

		
		
		String sql = "SELECT * FROM vsp where name='" + name+ "' and pass='" + pass + "' ";
		Statement stmt = connection.createStatement();
		ResultSet rs = stmt.executeQuery(sql);

		if (rs.next()==true)
		{
			                    String sql1="SELECT * FROM vsp where name='"+name+"' and status='Authorized' ";
								...
								if(rs1.next()==true)
								{
									...
									application.setAttribute("addr",s6);
								...
								else
								{
									%>
									    ...
									    <br/><br/><a href="v_login.jsp">Back</a>
									<%
								 }
