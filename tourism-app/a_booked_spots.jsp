  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  <p>&nbsp;</p>
          <h2 align="center">View All Booked Tourist Spots</h2>
		  <p>&nbsp;</p>
		 
		  
<p align="center"><a href="a_booked_users_locations.jsp" class="style10">View All Booked Users Locations in GMap</a></p>
 <p>&nbsp;</p>
...
<table width="764" border="1.5" cellpadding="0" cellspacing="0" align="center">
         <tr bgcolor="#00FF33">
		   ...
		   <td width="95" bgcolor="#9eb8dd"><div align="center" class="style3 style20 style27 style5 style7 style6"><strong>User </strong>Profile</div></td>
           ...
           <td width="86" bgcolor="#9eb8dd"><div align="center" class="style3 style20 style27 style5 style7 style6"><strong>Price<br />(in Rs.) </strong></div></td>	
		   ...
		   <td width="120" bgcolor="#9eb8dd"><div align="center" class="style3 style20 style27 style5 style7 style6"><strong>View in GMap </strong></div></td>	   
		 </tr>
 ...
 try 
	{
							...
							String query="select * from spot_book "; 
		...
		%>
                    ...
                    <tr>
					  ...
					  <td bgcolor="#CC0000"><div align="center" class="style5 style8 style6"><a href="a_user_profile.jsp?user=<%=s3%>&type=<%="four"%>"><%=s3%></a></div></td>
					  <td bgcolor="#CC0000"><div align="center" class="style5 style8 style6"><%=s2%></div></td>
					  <td bgcolor="#CC0000"><div align="center" class="style5 style8 style6"><a href="a_sp_profile.jsp?user=<%=s6%>&type=<%="four"%>"><%=s6%></a></div></td>
					  ...
					  <td bgcolor="#CC0000"><div align="center" class="style5 style8 style6"><a href="a_spot_details.jsp?loc=<%=s2%>&sp=<%=s6%>&type=<%="two"%>">Click here</a></div></td>
					  <td bgcolor="#CC0000"><div align="center" class="style5 style8 style6"><a href="https://www.google.com/maps/dir///@21.125498,81.914063,5z.jsp" target="_blank">Click here</a></div></td>
	               </tr>
