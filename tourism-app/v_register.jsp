...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center">Vehicle Service Provider Registration</h2>
		  <p>&nbsp;</p>
...
<form name="s" action="v_RegIns.jsp" method="post" enctype="multipart/form-data" onSubmit="return valid()"  ons target="_top">
		  
            <span class="style12 style7 style9 style1">
            <label for="name"> <br />
            </label>
            </span><span class="style7 style9 style1">
            <label for="name"></label>
            </span><span class="style9 style1">
            ...
            <p class="style14 style5 style6  style7 style8 style1"><input type="password" id="password" name="pass" class="text" /></p>
                  ...
                  <span class="style9 style20 style23 style5 style6  style7 style8 style1">
                  <label for="pic"><br />
                  </label>
                  </span>
                  ...
                  <p align="right"><a href="v_login.jsp" class="style2">Back</a></p>
</form>
