...
var na3=document.s.from.value;
if(na3=="")

{
alert("Please Enter From Location Name");
document.s.from.focus();
return false;
}

var na4=document.s.to.value;
if(na4=="")

{
alert("Please Enter To Location Name");
document.s.to.focus();
return false;
}
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center">Add Location</h2>
		  <p>&nbsp;</p>
		  
		  
		  
<form name="s" action="s_add_location1.jsp" method="post" onSubmit="return valid()"  ons target="_top">
		  
			
                  <span class="style9 style14 style20 style1 style6 style7 style8">
                  <label for="from">From (required)<br />
                  </label>
                  </span>
                  <p class="style14 style1 style6 style7 style8"><input id="s" name="from" class="text" />
                  </p>
				  
				  
				  <span class="style19 style9 style14 style23 style1 style6 style7 style8">
                  <label for="price">To (required)<br />
                  </label>
                  </span>
                  <p class="style9 style20 style5 style6  style7 style8 style1">
                    <input id="s" name="to" class="text" />
            </p>				  
