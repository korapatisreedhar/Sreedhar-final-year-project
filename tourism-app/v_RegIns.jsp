...
<%
					...
					try {
						...
						//image = image.replace(".", "_b.");
			 			String query1="select * from vsp where name='"+uname+"'"; 
					...
					if ( rs1.next() )
					   {
							...
							%>
							<p><a href="v_register.jsp">Back</a>         <a href="index.html">Home</a> </p>
							<%
					   }
					   else
					   {
					String str="waiting";
					PreparedStatement ps=connection.prepareStatement("insert into vsp(name,pass,email,mobile,addr,dob,gender,pin,location,image,status) values(?,?,?,?,?,?,?,?,?,?,?)");
						...
						if(x>0){
													...
													out.println("User Registered Sucessfully as Vehicle Service Provider");							
